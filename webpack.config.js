...
module.exports = {
  ...
  devServer: {
    ...
    proxy: {
      '/api/converge/*': {
        target: 'http://192.168.16.115:2100/service-converges',
        host: '192.168.16.115',
        secure: false,
        changeOrigin: true
      },
      '/api/pay/*': {
        target: 'http://demo.unitedview.cn:2200/service-pay',
        host: 'demo.unitedview.cn',
        secure: false,
        changeOrigin: true
      },
      '/api/log/*': {
        target: 'http://192.168.16.115:8103',
        host: '',
        secure: false,
        changeOrigin: true
      }
